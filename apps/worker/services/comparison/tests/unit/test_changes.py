...
class TestChanges:
    def test_get_changes_eof_case(self):
        ...
        second_file.append(2, ReportLine.create(0))
    ...
    def test_get_changes(self):
        ...
        second_deleted_file.append(10, ReportLine.create(0))
        second_deleted_file.append(11, ReportLine.create(0))
        second_deleted_file.append(12, ReportLine.create(0))
        first_report.append(second_deleted_file)
        # removed_all_covered_lines.py
        third_deleted_file = ReportFile("removed_all_covered_lines.py")
        third_deleted_file.append(10, ReportLine.create(0))
        ...
        second_added_file_unnaccounted_for.append(99, ReportLine.create(1))
        second_added_file_unnaccounted_for.append(101, ReportLine.create(0))
        ...
        first_old_renamed_and_missing.append(1, ReportLine.create(1))
        first_old_renamed_and_missing.append(2, ReportLine.create(1))
        first_old_renamed_and_missing.append(3, ReportLine.create(0))
        first_old_renamed_and_missing.append(8, ReportLine.create(0))
    ...
    def test_get_changes_missing_file(self):
        ...
        first_report_file.append(18, ReportLine.create(1))
        first_report = Report()
        second_report = Report()
